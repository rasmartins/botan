...
*/
class BOTAN_PUBLIC_API(2,9) Argon2 final : public PasswordHash
   {
   public:
...
class BOTAN_PUBLIC_API(2,9) Argon2_Family final : public PasswordHashFamily
   {
   public:
      Argon2_Family(uint8_t family) : m_family(family) {}
